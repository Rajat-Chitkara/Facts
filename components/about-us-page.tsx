      ...
      <header className="flex flex-col items-center mb-4 sm:mb-6 md:mb-8">
        <div className="flex items-center gap-3 sm:gap-4 mb-3 sm:mb-4">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-xs sm:text-sm md:text-base text-muted-foreground">Learn more about us</p>
          </div>
        </div>
      ...
      <main className="flex-grow">
        {isLoading ? (
          <div className="flex justify-center items-center py-12">
            ...
            <span className="ml-2 text-sm sm:text-base">Loading content...</span>
          </div>
        ) : content ? (
          <Card className="max-w-4xl mx-auto">
            ...
            <CardContent className="prose prose-sm sm:prose-base md:prose-lg dark:prose-invert max-w-none">
              <div dangerouslySetInnerHTML={{ __html: content.content }} />
              <p className="text-xs sm:text-sm text-muted-foreground mt-6 sm:mt-8 not-prose">
